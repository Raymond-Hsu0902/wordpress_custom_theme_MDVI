    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link navbar-item2" href="http://localhost/wordpress/認識協會/)" id="myBtn">認識協會_我是頁面</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost/wordpress/協會服務/" id="myBtn2">協會服務</a>
                </li>
                <li class="nav-item">
